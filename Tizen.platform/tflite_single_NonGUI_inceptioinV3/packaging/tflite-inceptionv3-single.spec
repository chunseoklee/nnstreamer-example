Name:		tflite-inceptionv3-single
...
mkdir -p %{buildroot}%{_datadir}/tflite/res
install -m 755 %{name} %{buildroot}%{_bindir}/%{name}
install -m 644 res/sample_pizza_299x299 %{buildroot}%{_datadir}/tflite/res/sample_pizza_299x299

%files
%manifest %{name}.manifest
%{_bindir}/%{name}
%{_datadir}/tflite/res/sample_pizza_299x299
